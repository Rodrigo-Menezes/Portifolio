...
export default function Servicos() {
  ...
  return (
    <div className=" w-screen h-screen  md:pl-80  md:pt-20 bg-slate-900 flex flex-col items-center">
      ...
      <div className="bg-slate-900 h-44">
        <div className="pl-5 md:pl-44 h-full pt-5 space-y-5 text-white w-screen border-t border-prata mt-5 ">
