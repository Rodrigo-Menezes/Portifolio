...
export default function Sobre() {
  ...
  return (
    <div className=" w-screen md:h-screen md:pl-80 pt-10 md:pt-20 pb-20 bg-gray-950 flex flex-col items-center">
      ...
      <div className='flex flex-wrap justify-center gap-10 md:gap-20 mt-20 px-3'>
        ...
        <div className='pt-2 flex flex-col items-center rounded-xl  shadow-custom'>
